...
},{"base64-js":"node_modules/base64-js/index.js","ieee754":"node_modules/ieee754/index.js","isarray":"node_modules/isarray/index.js","buffer":"node_modules/node-libs-browser/node_modules/buffer/index.js"}],"node_modules/socket.io-parser/is-buffer.js":[function(require,module,exports) {
...
},{"buffer":"node_modules/node-libs-browser/node_modules/buffer/index.js"}],"node_modules/socket.io-parser/binary.js":[function(require,module,exports) {
/*global Blob,File*/
...
},{"isarray":"node_modules/has-binary2/node_modules/isarray/index.js","buffer":"node_modules/node-libs-browser/node_modules/buffer/index.js"}],"node_modules/arraybuffer.slice/index.js":[function(require,module,exports) {
/**
...
},{"./url":"node_modules/socket.io-client/lib/url.js","socket.io-parser":"node_modules/socket.io-parser/index.js","./manager":"node_modules/socket.io-client/lib/manager.js","debug":"node_modules/socket.io-client/node_modules/debug/src/browser.js","./socket":"node_modules/socket.io-client/lib/socket.js"}],"src/connection.ts":[function(require,module,exports) {
"use strict";
...
var Connection = /*#__PURE__*/function () {
  function Connection(ip, port) {
    ...
    this.sock = socket_io_client_1.default('https://' + ip + ':' + port);
  }

  _createClass(Connection, [{
    key: "addListener",
    value: function addListener(subject, func) {
      this.sock.on(subject, func);
    }
  }, {
    key: "emitAction",
    value: function emitAction(subject, payload) {
...
exports.Connection = Connection; // sock.on('joined', (payload) => {
//     console.log(payload);
// });
},{"socket.io-client":"node_modules/socket.io-client/lib/index.js"}],"src/InputHandler.ts":[function(require,module,exports) {
"use strict";
...
var InputHandler = /*#__PURE__*/function () {
  function InputHandler(game) {
    ...
    for (var value in Object.keys(game_1.GameState)) {
      if (game_1.GameState[value] !== undefined) {
        this.keyboardEventListeners[value] = new Array();
        this.mouseEventListeners[value] = new Array();
      }
    }
  }

  _createClass(InputHandler, [{
    key: "addKeyboardEventListener",
    value: function addKeyboardEventListener(func, state) {
      this.keyboardEventListeners[state].push(func);
    }
  }, {
    key: "addMouseEventListener",
    value: function addMouseEventListener(func, state) {
    ...
    value: function onStateChange(newState) {
      ...
      this.keyboardEventListeners[this.game.gameState].forEach(function (func) {
        document.removeEventListener('keydown', func);
      });
      this.mouseEventListeners[this.game.gameState].forEach(function (func) {
        _this.game.canvas.removeEventListener('mousedown', func);
      }); //add new listeners

      this.keyboardEventListeners[newState].forEach(function (func) {
        document.addEventListener('keydown', func);
      });
      this.mouseEventListeners[newState].forEach(function (func) {
        _this.game.canvas.addEventListener('mousedown', func);
      });
    }
  }]);
...
},{"./game":"src/game.ts"}],"src/login.ts":[function(require,module,exports) {
"use strict";
...
var Login = /*#__PURE__*/function () {
  function Login(game) {
    ...
    this.focus = 'username';
    this.game.connection.addListener('login', function (payload) {
      if (_this.compare(payload, _this.inputs)) {
        _this.game.switchGameState(game_1.GameState.RUNNING);
      } else if (payload === 'invalid credentials') {
        setTimeout(function () {
          _this.errorMessage = false;
        }, 3000);
        _this.errorMessage = true;
        _this.inputs['password'] = '';
      }
    });
  }
  ...
  _createClass(Login, [{
    ...
    value: function onMouseDown(event) {
      var loginLeftX = this.game.canvas.width / 2 - this.lineDimensions.loginWidth / 2;
      var loginRightX = this.game.canvas.width / 2 + this.lineDimensions.loginWidth / 2;
      var loginTopY = this.game.canvas.height / 2 - this.lineDimensions.height;
      var loginBottomY = this.game.canvas.height / 2;
      var passLeftX = this.game.canvas.width / 2 - this.lineDimensions.passwordWidth / 2;
      var passRightX = this.game.canvas.width / 2 + this.lineDimensions.passwordWidth / 2;
      var passTopY = this.game.canvas.height / 2;
      var passBottomY = this.game.canvas.height / 2 + this.lineDimensions.height;
...
(function (GameState) {
  GameState[GameState["SETTINGS"] = 0] = "SETTINGS";
  GameState[GameState["RUNNING"] = 1] = "RUNNING";
  GameState[GameState["LOGIN"] = 2] = "LOGIN";
})(GameState = exports.GameState || (exports.GameState = {}));

;

var Game = /*#__PURE__*/function () {
  function Game(canvas, ip, port) {
    ...
    this.connection = new connection_1.Connection(ip, port);
  ...
  _createClass(Game, [{
    ...
    value: function update(deltaTime) {
      if (this.gameState === GameState.LOGIN) return;
    ...
    value: function draw(ctx) {
      switch (this.gameState) {
        ...
        case GameState.RUNNING:
          ...
          ctx.fillText(this.login.inputs['password'], this.canvas.width / 2, this.canvas.height / 2 + this.login.lineDimensions.height / 2); // LOGIN SUCCESS REMOVE LATER
    ...
    key: "switchGameState",
    value: function switchGameState(newState) {
      // call everything that needs to react on gamestate changes
      this.inputHandler.onStateChange(newState); // make sure gamestate in game object is updated LAST
...
exports.Game = Game;
},{"./connection":"src/connection.ts","./InputHandler":"src/InputHandler.ts","./login":"src/login.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
...
var game = new game_1.Game(canvas, ip, port);
var lastTime = 0;
